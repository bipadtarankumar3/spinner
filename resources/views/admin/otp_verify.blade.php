            ...
            <div class="col-xl-5 col-xxl-4">
              <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                <div class="col-sm-8 col-md-6 col-xl-9">
                  ...
                  <p class=" mb-9">Check Your OTP</p>

                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    
                  </h6>
                 
                  <form method="POST" action="{{URL::to('otp_verify')}}">
                    @csrf
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">OTP</label>
                      <input type="number" name="otp" class="form-control" id="exampleInputEmail1" placeholder="Enter OTP" aria-describedby="emailHelp" required>
                    </div>
