...
<body>
                    ...
                    <table style="width: 100%; border-spacing: 0px; ">
                        <tr>
                            <td style="padding: 40px 30px; font-family: 'Open Sans',serif ; background: #fff; padding-top: 0px;">
                                    <p style="font-size: 14px; margin-bottom: 0px; margin-top: 5px; text-align: left;"><b style="float: left;">Name :</b> <span style="margin-left: 5px">{{$e_contactDetails['Name']}}</span></p>
                                    <p style="font-size: 14px; margin-bottom: 0px; margin-top: 5px; text-align: left;"><b style="float: left;">Email :</b> <span style="margin-left: 5px">{{$e_contactDetails['Email']}}</span></p>

                                    <p style="font-size: 14px; margin-bottom: 0px; margin-top: 5px; text-align: left;"><b style="float: left;">Phone :</b> <span style="margin-left: 5px">{{$e_contactDetails['Phone']}}</span></p>

                                    <p style="font-size: 14px; margin-bottom: 0px; margin-top: 5px; text-align: left;"><b style="float: left;">Address :</b> <span style="margin-left: 5px">{{$e_contactDetails['booking_address']}}</span></p>

                                    <p style="font-size: 14px; margin-bottom: 0px; margin-top: 5px; text-align: left;"><b style="float: left;">Booking breakage :</b> <span style="margin-left: 5px">{{$e_contactDetails['booking_breakage']}}</span></p>
                                    

                                    <p style="font-size: 14px; margin-bottom: 0px; margin-top: 5px; text-align: justify;"><b style="float: left;">Message :</b> <span style="margin-left: 5px">{{$e_contactDetails['Message']}}</span></p>
    ...
    @else
        <table style="width: 100%; background: #f5f5f5; margin: 0 auto; border-spacing: 0px; ">
            ...
            <tr>
            <td style="padding: 40px 30px; font-family: 'Open Sans',serif ;     background: #fff; padding-top: 0px;">
                <h5 style="font-family: 'Open Sans',serif ; margin: 0px; font-size: 20px; margin-bottom: 8px;">Dear {{$e_contactDetails['Name']}},</h5>
