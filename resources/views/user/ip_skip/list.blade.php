        ...
        <div class="card">
            <div class="card-header">
                <div class="mb-2">
                    <div class="row">
                        <div class="col-md-10">
                            <h5 class="mb-0 mt-2">Ip Skip List</h5>
                        </div>
                        <div class="col-md-2">
                            <a href="{{URL::to('admin/add_ip_skip_page')}}" class="btn btn-info">Add Ip Skip</a>
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row my-4">
                    ...
                    <div class="col-md-8 text-center">
                        <h4 class="">Search</h4>
                        <form action="{{URL::to('admin/ip_skip')}}" method="post">
                            @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($ip_skip as $key=> $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->status}}</td>
                                    <td>
                                        <a href="{{URL::to('admin/edit_ip_skip/'.$item->id)}}"><i class="fas fa-edit"></i></a>
                                        <a href="{{URL::to('admin/delete_ip_skip/'.$item->id)}}" onclick="dataDelete(event)"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                <!-- end row --> 
                            @endforeach
